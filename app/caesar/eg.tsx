  ...
  return (
    <div className=" border-neutral-600 border-[0.1px] mt-1 text-stone-800 flex flex-col items-center justify-center p-4 md:p-6">
      <div className=" text-base">
        <h1 className="text-3xl font-bold mb-6 text-center text-stone-900">How Does the Caesar Cipher Work?</h1>
        ...
        <p className=" leading-relaxed mb-8">
          The formula to encrypt a letter is: <span className="font-mono bg-neutral-300 p-1 rounded">E(x) = (x + n) mod 26</span>, where <span className="font-mono bg-neutral-300 p-1 rounded">x</span> is the letter&apos;s position in the alphabet, and <span className="font-mono bg-neutral-300 p-1 rounded">n</span> is the number of positions to shift.
        </p>
        <div className="border-t border-neutral-700 pt-4">
          <h2 className="text-2xl font-bold mb-4 text-stone-900">Example</h2>
          <p className=" leading-relaxed mb-2">
            If we use a shift of 3 on the word <span className="font-bold text-stone-800">HELLO</span>:
          </p>
          <p className="w-fit font-mono bg-neutral-300 p-2 rounded mb-4">
            H → K, E → H, L → O, L → O, O → R
          </p>
          <p className="">The encrypted message is: <span className="font-bold text-stone-800">KHOOR</span></p>
        </div>
      </div>
    </div>
  )
